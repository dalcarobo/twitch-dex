function unifont(str, style) {
  ...
  const styles = {
    ...
    smallcaps: [
      ...` !"#$%&'()*+,-./0123456789:;<=>?@ᴀʙᴄᴅᴇꜰɢʜɪᴊᴋʟᴍɴᴏᴩQʀꜱᴛᴜᴠᴡxYᴢ[\\]^_\`ᴀʙᴄᴅᴇꜰɢʜɪᴊᴋʟᴍɴᴏᴩqʀꜱᴛᴜᴠᴡxyᴢ{|} ~`,
    ],
    superscript: [
      ...` !"#$%&'()*+,-./⁰¹²³⁴⁵⁶⁷⁸⁹:;<=>?@ᴬᴮᶜᴰᴱᶠᴳᴴᴵᴶᴷᴸᴹᴺᴼᴾQᴿˢᵀᵁⱽᵂˣʸᶻ[\\]^_\`ᵃᵇᶜᵈᵉᶠᵍʰⁱʲᵏˡᵐⁿᵒᵖqʳˢᵗᵘᵛʷˣʸᶻ{|}~`,
    ],
    sans: [
  ...
  if (!font)
    throw new Error(
      `${style} is not a valid style! choose ${Object.keys(styles)}`
    );
